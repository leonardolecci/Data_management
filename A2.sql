...
SELECT IFNULL(revenue, 0), IFNULL(ret_ref_disc, 0), IFNULL(cogs, 0), IFNULL(adm_exp, 0), IFNULL(sell_exp, 0), IFNULL(other_exp, 0),
    IFNULL(other_inc, 0), IFNULL(income_tax, 0), IFNULL(other_tax, 0),
       (IFNULL(revenue, 0) - IFNULL(ret_ref_disc, 0) - IFNULL(cogs, 0) - IFNULL(adm_exp, 0) - IFNULL(sell_exp, 0) - IFNULL(other_exp, 0)
